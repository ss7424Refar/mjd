...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_9.setGeometry(QtCore.QRect(10, 0, 311, 31))
...
"color: rgb(255, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Shift Start Day"))
        self.label_5.setText(_translate("MainWindow", "Shift Start Hour"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "line keyword search"))
        ...
        self.comboBox_4.setCurrentText(_translate("MainWindow", "Selection Order: Line - Shift - Model - Station"))
        self.comboBox_4.setItemText(0, _translate("MainWindow", "Selection Order: Line - Shift - Model - Station"))
        self.label.setText(_translate("MainWindow", "Line"))
        self.label_6.setText(_translate("MainWindow", "Station"))
        self.label_7.setText(_translate("MainWindow", "Station Config"))
        self.radioButton.setText(_translate("MainWindow", "Dynamic Detection"))
        self.radioButton_2.setText(_translate("MainWindow", "Static Detection"))
        self.pushButton_4.setText(_translate("MainWindow", "Add"))
        item = self.tableWidget_2.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Dynamic Template"))
        item = self.tableWidget_2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "File Count"))
        item = self.tableWidget_3.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Static Template"))
        item = self.tableWidget_3.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "File Count"))
        self.pushButton_2.setText(_translate("MainWindow", "Start Line"))
        self.pushButton_3.setText(_translate("MainWindow", "Reset SystemDate"))
        self.pushButton_5.setText(_translate("MainWindow", "Clear ListVIew"))
        self.pushButton.setText(_translate("MainWindow", "Stop Line"))
        self.pushButton_6.setText(_translate("MainWindow", " Refresh Data"))
        self.label_9.setText(_translate("MainWindow", "Config ListView:  Line - Shift - Model - Station"))
        self.menu.setTitle(_translate("MainWindow", "Data Creater"))
        self.actionLine.setText(_translate("MainWindow", "Lines"))
